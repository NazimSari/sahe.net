    ...
    <div className="w-full lg:w-1/4 mt-2 p-3">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button className="py-3 text-[#160317] font-semibold border bg-[#f5f5f5] hover:bg-[#160317] hover:text-[#f5f5f5] border-[#f5f5f5] rounded-md transition duration-300 ease-in-out cursor-pointer">
            Hemen Üye Ol
          </button>
