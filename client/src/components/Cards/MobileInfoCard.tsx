...
const MobileInfoCard: React.FC<MobilStageCardProps> = ({ item, type }) => {
  return (
    <LoaderLink
      ...
      className="block"
    >
      <div className="slider-card bg-black rounded-lg shadow-lg overflow-hidden transform w-[min(80vw,280px)] min-h-[400px] max-h-[500px] transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl flex flex-col cursor-pointer">
        {/* Üst görsel alanı */}
        ...
        <div className="px-4 flex flex-col flex-grow gap-2">
          <span className="text-[#9D9D9D] text-xs font-semibold mt-2">
            {item.category.join(", ")} {/* string[] birleştir */}
          </span>
        ...
        <div className="p-4 flex items-center justify-between shrink-0">
          <span className="flex items-center text-xs text-[#FF007A] font-semibold">
            Rezervasyon Yap
